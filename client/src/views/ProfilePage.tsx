...
function ProfilePage() {
  ...
  const fetchUserPosts = async () => {
    ...
    try {
      // If username is 'me', fetch the current user's info first
      let targetUsername = username;
      if (username === 'me') {
        const currentUserInfo = await getUserInfo();
        setUserInfo(currentUserInfo);
        targetUsername = currentUserInfo.username;
      } else {
        // TODO: Fetch the profile user's info from an API endpoint
      ...
      const fetchedPosts = await getPostsByUsername(targetUsername);
